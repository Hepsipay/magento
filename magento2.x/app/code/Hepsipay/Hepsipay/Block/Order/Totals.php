 ...
 */
namespace Hepsipay\Hepsipay\Block\Order;
...
class Totals extends \Magento\Framework\View\Element\Template
{
    ...
    protected function _initTotals()
    {
        ...
        /*
        * set Hepsipay Commission added to GrandTotal
        */       
        $grand_total_with_commission = $this->getSource()->getHepsipayCommission() + $this->getSource()->getGrandTotal();
        ...
        /**
         * Add Hepsipay Commission
         */
        if($this->getSource()->getHepsipayCommission()){
            $this->_totals['hepsipay_commission'] = new \Magento\Framework\DataObject(
                [
                    'code' => 'hepsipay_commission',
                    'value' => $this->getSource()->getHepsipayCommission(),
                    'base_value' => $this->getSource()->getHepsipayCommission(),
                    'label' => __('Commission'),
                ]
            );
        }
